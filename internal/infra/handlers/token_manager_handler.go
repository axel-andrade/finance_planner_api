...
func (tmi *TokenManagerHandler) GenerateToken(userid string) (*domain.TokenDetails, error) {
...
func (tmi *TokenManagerHandler) ExtractTokenMetadata(encoded string) (*domain.AccessDetails, error) {
...
func (tmi *TokenManagerHandler) createAccessToken(td *domain.TokenDetails, userid string) error {
	var err error
...
func (e *TokenManagerHandler) createRefreshToken(td *domain.TokenDetails, userid string) error {
	var err error
...
func (e *TokenManagerHandler) configureExpiration(td *domain.TokenDetails) error {
